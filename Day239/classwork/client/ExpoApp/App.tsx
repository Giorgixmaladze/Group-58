...
export default function App() {
  ...
  return (
    <View style={[styles.safeArea,darkMode&&{backgroundColor:"black"}]}>
      <KeyboardAvoidingView
        behavior={Platform.OS === 'ios' ? 'padding' : 'height'}
        style={styles.container}
      >
        <View style={styles.header}>
          <Text style={[styles.title,darkMode&&{color:"white"}]}>My Tasks</Text>
          <Text style={[styles.subtitle,darkMode&&{color:"white"}]}>{tasks.length} tasks for today</Text>
          <Switch value={darkMode} onValueChange={()=> setDarkMode(!darkMode)} />
        </View>

        <View style={styles.inputSection}>
          <TextInput
            style={[styles.input,darkMode&&{backgroundColor:"grey",color:"white"}]}
